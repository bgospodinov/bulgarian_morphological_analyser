...
# example  . predictions/compute_pred_btb.sh predictions/btb/bg-dev-pred.txt data/MorphoData-NewSplit/bg-dev.txt.conv
# example  . predictions/compute_pred_btb.sh predictions/btb/bg-test-pred.txt data/MorphoData-NewSplit/bg-test.txt.conv
